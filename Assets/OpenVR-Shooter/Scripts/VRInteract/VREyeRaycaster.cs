...
public class VREyeRaycaster : MonoBehaviour
{
	...
	[SerializeField] public LayerMask m_ExclusionLayers;     
    ...
    // Optionally show the debug ray.	[SerializeField] private float m_RayLength = 500f;              
    // How far into the scene the ray is cast.


	private VRInteractable m_CurrentInteractible;                
    //The current interactive item
	private VRInteractable m_LastInteractible;                   
